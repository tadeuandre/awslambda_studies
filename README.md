# education-online serverless API
The education-online project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=education-online -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot2-archetype -DarchetypeVersion=1.3.1 -DgroupId=com.infnet -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd education-online
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "EducationOnlineApi",
                    "OutputKey": "EducationOnlineApi",
